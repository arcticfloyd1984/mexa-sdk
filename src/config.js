...
const RESPONSE_CODES = {
    ...
    INVALID_DATA: 'B514',
    ONBOARD_INITIALIZATION_ERROR: 'B515',
    ONBOARD_WALLET_SELECT: 'B516',
    ONBOARD_WALLET_CHECK: 'B517',
    NOTIFY_INITIALIZATION_ERROR: 'B518',
    NOTIFY_PARAMS_ERROR: 'B519',
    NOTIFY_ACCOUNT_EVENTS_ERROR: 'B520'
};
